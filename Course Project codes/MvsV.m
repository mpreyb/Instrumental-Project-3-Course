% MvsV - Análisis del voltaje aplicado y el factor de multiplicación de un detector de radiación tipo contador proporcional
% Universidad EAFIT, Departamento de Ciencias Físicas
% PROYECTO INSTRUMENTAL 3 - INFORME FINAL DE PROYECTO DE MATERIA
%
% Inputs:
%    a - Radio del ánodo (m)
...
%
% Autor: Maria Paula Rey Barrera
% email: mpreyb@eafit.edu.co
% Abril 2022; Última revisión: 26-Nov-2022
